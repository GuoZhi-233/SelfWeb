        ...
        return (
           <div className="pt-32 w-full max-w-5xl mx-auto text-center animate-fade-in px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 {/* Email */}
                  <div className="block p-2 border-2 border-gray-100 dark:border-gray-800 rounded-[2rem] group cursor-default hover:border-orange-500 transition-colors duration-300">
                     ...
                     <p className="text-lg opacity-70 text-gray-500 dark:text-gray-400 transition-colors duration-300 select-text text-center break-words whitespace-pre-line">
                       {content.email}
                     </p>
                  </div>
