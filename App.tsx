        ...
        return (
           <div className="pt-32 w-full max-w-5xl mx-auto text-center animate-fade-in px-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                 {/* Email */}
                  <div className="block p-6 border-2 border-gray-100 dark:border-gray-800 rounded-[2rem] group cursor-default hover:border-orange-500 transition-colors duration-300">
