...
export const EDUCATION_DATA: Record<Language, EducationPageContent> = {
  zh: {
    title: "教育经历",
    about: "我于2026年7月毕业于朴茨茅斯大学创意媒体技术专业，并取得一等荣誉学士学位。对技术美术和创意叙事充满热情，专注于通过AI辅助工作流程、动作捕捉和交互式原型设计来桥接艺术愿景与技术执行之间的差距。除了技术方面，我还是ACG（动画、漫画和游戏）文化的忠实创造者和消费者，曾制作的视频内容累计观看次数超过5万次。我热衷于优化生产流程，并在创意项目中寻找有目的的工作流，无论是日常的生活规划还是系统化复杂的技术文档。",
    ...
    experiences: [
      {
        id: '1',
        year: 'Class of 2026',
        title: 'First-Class BSc (Hons) in Creative Media Technologies',
