...
- The 3D logo is rendered in Three.js from the original two Bézier paths, with charcoal and lime glass, beveled extrusion and an environment map. It loads near the viewport and stops animating offscreen. Pointer movement rotates the mark gently, while reduced-motion preferences keep it still. No stock plant photographs are used.
